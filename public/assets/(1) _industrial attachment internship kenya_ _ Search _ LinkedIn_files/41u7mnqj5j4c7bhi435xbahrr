...
define("participate-text-editor/components/ghost-text-cta",["exports","@ember/component","@ember/template-factory","@ember/component/template-only"],(function(e,t,i,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
const a=(0,i.createTemplateFactory)({id:"P+Yk/2LB",block:'[[[41,[30,1],[[[1,"  "],[10,0],[14,0,"editor-ghost-text-cta__wrapper"],[12],[1,"\\n    "],[10,1],[14,0,"editor-ghost-text-cta__placeholder"],[14,"aria-hidden","true"],[12],[1,[30,2]],[13],[1,"\\n\\n    "],[11,"button"],[24,0,"editor-ghost-text-cta__button"],[24,4,"button"],[4,[38,1],["click",[30,3]],null],[4,[38,2],["open_wa_ghost"],null],[12],[1,"\\n      "],[10,1],[14,0,"editor-ghost-text-cta__button--text"],[12],[1,[30,4]],[13],[1,"\\n      "],[8,[39,3],[[24,0,"editor-ghost-text-cta__button--icon"]],[["@type","@size","@name"],["system","medium","magic-wand"]],null],[1,"\\n    "],[13],[1,"\\n  "],[13],[1,"\\n"]],[]],null]],["@isEditorEmpty","@placeholder","@ghostCtaAction","@ghostCtaText"],false,["if","on","ember-cli-pemberly-tracking@track-interaction","hue-web-icons@icon"]]',moduleName:"participate-text-editor/components/ghost-text-cta.hbs",isStrictMode:!1})
...
e&&(0,T.addEventListener)(this,e,"scroll",this._onScroll)}}_onScroll(){(0,T.throttleTask)(this,"_closeTypeahead",(0,T.getTimeoutOrTestFallback)(100))}willDestroy(){super.willDestroy(...arguments)
this.scrollableContainerEl&&(0,T.removeEventListener)(this,this.scrollableContainerEl,"scroll",this._onScroll)}_dismissTypeaheadWithoutSelection(){var e
...
if(a||o){const a=(0,x.deltaFromTextMentionsObject)(e)
...
r.setSelection(n,s)}}_checkIfEditorIsEmpty(e){const{text:t}=(0,x.deltaToTextMentionsObject)(e)
this.isEditorEmpty=0===t.length}_handleTextChanges(e){this._checkIfEditorIsEmpty(e);(0,T.debounceTask)(this,"_handleTextChangesDebounced",e,(0,T.getTimeoutOrTestFallback)(300))}_handleTextChangesDebounced(e){var t,i
if(!e)return
const{mentions:r,text:a}=(0,x.deltaToTextMentionsObject)(e),o=e.ops.filter((e=>{var t,i
return!(null!==(t=e.attributes)&&void 0!==t&&t.mention||null!==(i=e.attributes)&&void 0!==i&&i.hashtag)})).reduce(((e,t)=>e.concat((0,v.getUrlsFromText)(t.insert,!0))),[])
if(o.length){var n,s
...
2===e.length&&U.test(e)&&this.editor.setText("")}}_trackTypeaheadRenderedImpressionsSetup(e){switch(this.typeaheadType){case u.TYPEAHEAD_TYPES_MAP.MENTION:{const t={searchHeader:(0,k.getSearchHeaderForMentionsTrackingEvent)(this.typeaheadQuery),results:(0,m.getFormattedMentionsResults)(e)}
this._fireCustomTexteditorTrackingEvent("MentionSuggestionImpressionEvent",t,u.TYPEAHEAD_TYPES_MAP.MENTION)
break}case u.TYPEAHEAD_TYPES_MAP.HASHTAG:{const t={searchHeader:(0,w.getSearchHeaderForHashtagTrackingEvent)(this.typeaheadQuery),results:(0,m.getFormattedHashtagResults)(e),hashtagSourceType:"TYPEAHEAD"}
...
if(!e.isComposing)if(this.typeaheadPopulatedwithType){if((0,h.isDownArrowKey)(e))this._handleArrowKey(e,u.KEY_DOWN)
...
const{text:e,mentions:t}=(0,x.deltaToTextMentionsObject)(this.editor.getContents())
...
null===(i=this.onTypeaheadSelect)||void 0===i||i.call(this,a,r)}},A=(0,r.default)(P.prototype,"tracking",[S],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,r.default)(P.prototype,"lix",[C],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,r.default)(P.prototype,"i18n",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),M=(0,r.default)(P.prototype,"hashtagShouldOpen",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),I=(0,r.default)(P.prototype,"isEditorEmpty",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!0}}),H=(0,r.default)(P.prototype,"mentionShouldOpen",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),j=(0,r.default)(P.prototype,"workflowId",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,r.default)(P.prototype,"typeaheadsAreDisabled",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),z=(0,r.default)(P.prototype,"typeaheadQuery",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,r.default)(P.prototype,"commentary",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,r.default)(P.prototype,"initEditor",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"initEditor"),P.prototype),(0,r.default)(P.prototype,"onEditorEvents",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"onEditorEvents"),P.prototype),(0,r.default)(P.prototype,"onDisabledAttrChange",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"onDisabledAttrChange"),P.prototype),(0,r.default)(P.prototype,"onEditorDragover",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"onEditorDragover"),P.prototype),(0,r.default)(P.prototype,"onTypeaheadResultsRendered",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"onTypeaheadResultsRendered"),P.prototype),(0,r.default)(P.prototype,"transformTypeaheadResponse",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"transformTypeaheadResponse"),P.prototype),(0,r.default)(P.prototype,"typeaheadSelect",[p.action],Object.getOwnPropertyDescriptor(P.prototype,"typeaheadSelect"),P.prototype),P)
e.default=K;(0,o.setComponentTemplate)(L,K)}))
...
define.alias("ember-async-data/helpers/load","participate-text-editor/helpers/load")
...
define.alias("ember-async-data/tracked-async-data","participate-text-editor/tracked-async-data")
