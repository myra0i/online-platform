...
switch(t){case W:e.stopPropagation()
this.closeSearch()
break
...
this.debounce=(0,_.debounceTask)(this,"_searchGifs",600)}selectGif(e){var t,r
...
e.default=A;(0,o.setComponentTemplate)(H,A)}))
